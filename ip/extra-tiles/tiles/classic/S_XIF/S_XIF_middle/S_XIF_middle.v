...
`endif
 ...
 //E
        ...
        input  [15:0] right2middle_RESULT,        //Port(Name=right2middle_RESULT,IO=INPUT,XOffset=-1,YOffset=0,WireCount=16,Side=E)
        output  [31:0] middle2right_ISSUE_OPB,        //Port(Name=middle2right_ISSUE_OPB,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=32,Side=E)
 //W
        ...
        input  [15:0] left2middle_RESULT,        //Port(Name=left2middle_RESULT,IO=INPUT,XOffset=1,YOffset=0,WireCount=16,Side=W)
        output  [31:0] middle2left_ISSUE_OPA,        //Port(Name=middle2left_ISSUE_OPA,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=32,Side=W)
...
S_XIF_middle_switch_matrix Inst_S_XIF_middle_switch_matrix (
    ...
    .RESULT30(RESULT30),
    .RESULT31(RESULT31),
    .ConfigBits(ConfigBits[75-1:0]),
    .ConfigBits_N(ConfigBits_N[75-1:0])
);
