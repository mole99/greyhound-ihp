...
`endif
 ...
 //E
        ...
        output  [15:0] left2middle_RESULT,        //Port(Name=left2middle_RESULT,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=16,Side=E)
        input  [31:0] middle2left_ISSUE_OPA,        //Port(Name=middle2left_ISSUE_OPA,IO=INPUT,XOffset=-1,YOffset=0,WireCount=32,Side=E)
 //W
