...
`endif
 ...
 //Tile_X0Y0_Direction.WEST
    ...
    wire[15:0] Tile_X0Y0_left2middle_RESULT; //Port(Name=left2middle_RESULT,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=16,Side=E)
 //Tile_X1Y0_Direction.WEST
    ...
    wire[31:0] Tile_X1Y0_middle2right_ISSUE_OPB; //Port(Name=middle2right_ISSUE_OPB,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=32,Side=E)
 //Tile_X1Y0_Direction.WEST
    wire[3:0] Tile_X1Y0_W_GBUF_FEED_BEG; //Port(Name=W_GBUF_FEED_BEG,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=4,Side=W)
    wire[31:0] Tile_X1Y0_middle2left_ISSUE_OPA; //Port(Name=middle2left_ISSUE_OPA,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=32,Side=W)
 //Tile_X2Y0_Direction.WEST
    wire[3:0] Tile_X2Y0_W_GBUF_FEED_BEG; //Port(Name=W_GBUF_FEED_BEG,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=4,Side=W)
    wire[15:0] Tile_X2Y0_right2middle_RESULT; //Port(Name=right2middle_RESULT,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=16,Side=W)
