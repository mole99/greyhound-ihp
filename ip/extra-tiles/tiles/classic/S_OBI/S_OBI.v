...
`endif
    ...
    //Tile_X0Y0_Direction.NORTH
        ...
        output  [0:0] Tile_X0Y0_Co, //Port(Name=Co,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=1,Side=N)
    ...
    //Tile_X0Y0_Direction.WEST
        output  [3:0] Tile_X0Y0_W_GBUF_FEED_BEG, //Port(Name=W_GBUF_FEED_BEG,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=4,Side=W)
        input  [3:0] Tile_X0Y0_E_GBUF_END, //Port(Name=E_GBUF_END,IO=INPUT,XOffset=1,YOffset=0,WireCount=4,Side=W)
    //Tile_X1Y0_Direction.NORTH
        output  [3:0] Tile_X1Y0_N_GBUF_BEG, //Port(Name=N_GBUF_BEG,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=4,Side=N)
        output  [3:0] Tile_X1Y0_N1BEG, //Port(Name=N1BEG,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=4,Side=N)
        output  [7:0] Tile_X1Y0_N2BEG, //Port(Name=N2BEG,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=8,Side=N)
        output  [7:0] Tile_X1Y0_N2BEGb, //Port(Name=N2BEGb,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=8,Side=N)
        output  [15:0] Tile_X1Y0_N4BEG, //Port(Name=N4BEG,IO=OUTPUT,XOffset=0,YOffset=-4,WireCount=4,Side=N)
        output  [15:0] Tile_X1Y0_NN4BEG, //Port(Name=NN4BEG,IO=OUTPUT,XOffset=0,YOffset=-4,WireCount=4,Side=N)
        output  [0:0] Tile_X1Y0_Co, //Port(Name=Co,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=1,Side=N)
        input  [3:0] Tile_X1Y0_S1END, //Port(Name=S1END,IO=INPUT,XOffset=0,YOffset=1,WireCount=4,Side=N)
        input  [7:0] Tile_X1Y0_S2MID, //Port(Name=S2MID,IO=INPUT,XOffset=0,YOffset=1,WireCount=8,Side=N)
        input  [7:0] Tile_X1Y0_S2END, //Port(Name=S2END,IO=INPUT,XOffset=0,YOffset=1,WireCount=8,Side=N)
        input  [15:0] Tile_X1Y0_S4END, //Port(Name=S4END,IO=INPUT,XOffset=0,YOffset=4,WireCount=4,Side=N)
        input  [15:0] Tile_X1Y0_SS4END, //Port(Name=SS4END,IO=INPUT,XOffset=0,YOffset=4,WireCount=4,Side=N)
    //Tile_X2Y0_Direction.NORTH
        output  [3:0] Tile_X2Y0_N_GBUF_BEG, //Port(Name=N_GBUF_BEG,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=4,Side=N)
        output  [3:0] Tile_X2Y0_N1BEG, //Port(Name=N1BEG,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=4,Side=N)
        output  [7:0] Tile_X2Y0_N2BEG, //Port(Name=N2BEG,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=8,Side=N)
        output  [7:0] Tile_X2Y0_N2BEGb, //Port(Name=N2BEGb,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=8,Side=N)
        output  [15:0] Tile_X2Y0_N4BEG, //Port(Name=N4BEG,IO=OUTPUT,XOffset=0,YOffset=-4,WireCount=4,Side=N)
        output  [15:0] Tile_X2Y0_NN4BEG, //Port(Name=NN4BEG,IO=OUTPUT,XOffset=0,YOffset=-4,WireCount=4,Side=N)
        output  [0:0] Tile_X2Y0_Co, //Port(Name=Co,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=1,Side=N)
        input  [3:0] Tile_X2Y0_S1END, //Port(Name=S1END,IO=INPUT,XOffset=0,YOffset=1,WireCount=4,Side=N)
        input  [7:0] Tile_X2Y0_S2MID, //Port(Name=S2MID,IO=INPUT,XOffset=0,YOffset=1,WireCount=8,Side=N)
        input  [7:0] Tile_X2Y0_S2END, //Port(Name=S2END,IO=INPUT,XOffset=0,YOffset=1,WireCount=8,Side=N)
        input  [15:0] Tile_X2Y0_S4END, //Port(Name=S4END,IO=INPUT,XOffset=0,YOffset=4,WireCount=4,Side=N)
        input  [15:0] Tile_X2Y0_SS4END, //Port(Name=SS4END,IO=INPUT,XOffset=0,YOffset=4,WireCount=4,Side=N)
    //Tile_X2Y0_Direction.WEST
        input  [3:0] Tile_X2Y0_W_GBUF_FEED_END, //Port(Name=W_GBUF_FEED_END,IO=INPUT,XOffset=-1,YOffset=0,WireCount=4,Side=E)
        output  [3:0] Tile_X2Y0_E_GBUF_BEG, //Port(Name=E_GBUF_BEG,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=4,Side=E)
 ...
 //signal declarations
 //Tile_X0Y0_Direction.WEST
    wire[3:0] Tile_X0Y0_E_GBUF_BEG; //Port(Name=E_GBUF_BEG,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=4,Side=E)
    wire[9:0] Tile_X0Y0_left2middle_RDATA; //Port(Name=left2middle_RDATA,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=10,Side=E)
 //Tile_X1Y0_Direction.WEST
    wire[3:0] Tile_X1Y0_E_GBUF_BEG; //Port(Name=E_GBUF_BEG,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=4,Side=E)
    wire[9:0] Tile_X1Y0_middle2right_WDATA; //Port(Name=middle2right_WDATA,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=10,Side=E)
    wire[9:0] Tile_X1Y0_middle2right_ADDR; //Port(Name=middle2right_ADDR,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=10,Side=E)
 //Tile_X1Y0_Direction.WEST
    wire[3:0] Tile_X1Y0_W_GBUF_FEED_BEG; //Port(Name=W_GBUF_FEED_BEG,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=4,Side=W)
    wire[9:0] Tile_X1Y0_middle2left_WDATA; //Port(Name=middle2left_WDATA,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=10,Side=W)
    wire[9:0] Tile_X1Y0_middle2left_ADDR; //Port(Name=middle2left_ADDR,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=10,Side=W)
 //Tile_X2Y0_Direction.WEST
    wire[3:0] Tile_X2Y0_W_GBUF_FEED_BEG; //Port(Name=W_GBUF_FEED_BEG,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=4,Side=W)
    wire[9:0] Tile_X2Y0_right2middle_RDATA; //Port(Name=right2middle_RDATA,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=10,Side=W)
...
`endif
    ...
    .Co(Tile_X0Y0_Co),
    .E_GBUF_BEG(Tile_X0Y0_E_GBUF_BEG),
    .left2middle_RDATA(Tile_X0Y0_left2middle_RDATA),
    .W_GBUF_FEED_BEG(Tile_X0Y0_W_GBUF_FEED_BEG),
...
`endif
    ...
    (
    .E_GBUF_END(Tile_X0Y0_E_GBUF_BEG),
    .left2middle_RDATA(Tile_X0Y0_left2middle_RDATA),
    ...
    .W_GBUF_FEED_END(Tile_X2Y0_W_GBUF_FEED_BEG),
    .right2middle_RDATA(Tile_X2Y0_right2middle_RDATA),
    .N_GBUF_BEG(Tile_X1Y0_N_GBUF_BEG),
...
`endif
    ...
    (
    .E_GBUF_END(Tile_X1Y0_E_GBUF_BEG),
    .middle2right_WDATA(Tile_X1Y0_middle2right_WDATA),
    .middle2right_ADDR(Tile_X1Y0_middle2right_ADDR),
    ...
    .W_GBUF_FEED_END(Tile_X2Y0_W_GBUF_FEED_END),
    .N_GBUF_BEG(Tile_X2Y0_N_GBUF_BEG),
    ...
    .Co(Tile_X2Y0_Co),
    .E_GBUF_BEG(Tile_X2Y0_E_GBUF_BEG),
    .W_GBUF_FEED_BEG(Tile_X2Y0_W_GBUF_FEED_BEG),
    .right2middle_RDATA(Tile_X2Y0_right2middle_RDATA),
