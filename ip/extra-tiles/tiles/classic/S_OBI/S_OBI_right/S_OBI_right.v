...
`endif
 ...
 //W
        ...
        output  [9:0] right2middle_RDATA,        //Port(Name=right2middle_RDATA,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=10,Side=W)
        input  [9:0] middle2right_WDATA,        //Port(Name=middle2right_WDATA,IO=INPUT,XOffset=1,YOffset=0,WireCount=10,Side=W)
        input  [9:0] middle2right_ADDR,        //Port(Name=middle2right_ADDR,IO=INPUT,XOffset=1,YOffset=0,WireCount=10,Side=W)
...
S_OBI_right_switch_matrix Inst_S_OBI_right_switch_matrix (
    ...
    .ConfigBits(ConfigBits[78-1:0]),
    .ConfigBits_N(ConfigBits_N[78-1:0])
);
