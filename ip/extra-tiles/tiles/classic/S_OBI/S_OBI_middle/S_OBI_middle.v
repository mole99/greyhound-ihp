...
`endif
 ...
 //E
        ...
        input  [9:0] right2middle_RDATA,        //Port(Name=right2middle_RDATA,IO=INPUT,XOffset=-1,YOffset=0,WireCount=10,Side=E)
        output  [9:0] middle2right_WDATA,        //Port(Name=middle2right_WDATA,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=10,Side=E)
        output  [9:0] middle2right_ADDR,        //Port(Name=middle2right_ADDR,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=10,Side=E)
 //W
        ...
        input  [9:0] left2middle_RDATA,        //Port(Name=left2middle_RDATA,IO=INPUT,XOffset=1,YOffset=0,WireCount=10,Side=W)
        output  [9:0] middle2left_WDATA,        //Port(Name=middle2left_WDATA,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=10,Side=W)
        output  [9:0] middle2left_ADDR,        //Port(Name=middle2left_ADDR,IO=OUTPUT,XOffset=-1,YOffset=0,WireCount=10,Side=W)
        input  REQ_top,
        input  WE_top,
        input  BE_top0,
        input  BE_top1,
...
S_OBI_middle_switch_matrix Inst_S_OBI_middle_switch_matrix (
    ...
    .RDATA30(RDATA30),
    .RDATA31(RDATA31),
    .ConfigBits(ConfigBits[94-1:0]),
    .ConfigBits_N(ConfigBits_N[94-1:0])
);
