...
`endif
 ...
 //E
        ...
        output  [9:0] left2middle_RDATA,        //Port(Name=left2middle_RDATA,IO=OUTPUT,XOffset=1,YOffset=0,WireCount=10,Side=E)
        input  [9:0] middle2left_WDATA,        //Port(Name=middle2left_WDATA,IO=INPUT,XOffset=-1,YOffset=0,WireCount=10,Side=E)
        input  [9:0] middle2left_ADDR,        //Port(Name=middle2left_ADDR,IO=INPUT,XOffset=-1,YOffset=0,WireCount=10,Side=E)
 //W
