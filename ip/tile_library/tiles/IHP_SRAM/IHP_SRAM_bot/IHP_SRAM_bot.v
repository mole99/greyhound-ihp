...
`endif
 ...
 //Side.NORTH
        ...
        output  [15:0] bot2top_A_DOUT,        //Port(Name=bot2top_A_DOUT, IO=OUTPUT, XOffset=0, YOffset=-1, WireCount=16, Side=NORTH)
        input  [15:0] top2bot_A_DIN,        //Port(Name=top2bot_A_DIN, IO=INPUT, XOffset=0, YOffset=1, WireCount=16, Side=NORTH)
        input  [15:0] top2bot_A_BM,        //Port(Name=top2bot_A_BM, IO=INPUT, XOffset=0, YOffset=1, WireCount=16, Side=NORTH)
