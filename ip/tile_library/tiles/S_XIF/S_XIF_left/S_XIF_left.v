...
`endif
 ...
 //Side.EAST
        output  [15:0] left2middle_RESULT,        //Port(Name=left2middle_RESULT, IO=OUTPUT, XOffset=1, YOffset=0, WireCount=16, Side=EAST)
        input  [31:0] middle2left_ISSUE_OPA,        //Port(Name=middle2left_ISSUE_OPA, IO=INPUT, XOffset=-1, YOffset=0, WireCount=32, Side=EAST)
...
S_XIF_left_ConfigMem
`ifdef EMULATION
    #(
    .Emulate_Bitstream(Emulate_Bitstream)
    )
`endif
    Inst_S_XIF_left_ConfigMem
    (
    .FrameData(FrameData),
...
S_XIF_left_switch_matrix Inst_S_XIF_left_switch_matrix (
    .S1END0(S1END[0]),
    .S1END1(S1END[1]),
    .S1END2(S1END[2]),
    .S1END3(S1END[3]),
    ...
    .ConfigBits(ConfigBits[64-1:0]),
    .ConfigBits_N(ConfigBits_N[64-1:0])
);
