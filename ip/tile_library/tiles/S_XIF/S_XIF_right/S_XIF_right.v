...
`endif
 ...
 //Side.WEST
        output  [15:0] right2middle_RESULT,        //Port(Name=right2middle_RESULT, IO=OUTPUT, XOffset=-1, YOffset=0, WireCount=16, Side=WEST)
        input  [31:0] middle2right_ISSUE_OPB,        //Port(Name=middle2right_ISSUE_OPB, IO=INPUT, XOffset=1, YOffset=0, WireCount=32, Side=WEST)
