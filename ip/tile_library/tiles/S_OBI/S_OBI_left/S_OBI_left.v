...
`endif
 ...
 //Side.EAST
        output  [9:0] left2middle_RDATA,        //Port(Name=left2middle_RDATA, IO=OUTPUT, XOffset=1, YOffset=0, WireCount=10, Side=EAST)
        input  [9:0] middle2left_WDATA,        //Port(Name=middle2left_WDATA, IO=INPUT, XOffset=-1, YOffset=0, WireCount=10, Side=EAST)
        input  [9:0] middle2left_ADDR,        //Port(Name=middle2left_ADDR, IO=INPUT, XOffset=-1, YOffset=0, WireCount=10, Side=EAST)
...
S_OBI_left_ConfigMem
`ifdef EMULATION
    #(
    .Emulate_Bitstream(Emulate_Bitstream)
    )
`endif
    Inst_S_OBI_left_ConfigMem
    (
    .FrameData(FrameData),
...
S_OBI_left_switch_matrix Inst_S_OBI_left_switch_matrix (
    .S1END0(S1END[0]),
    .S1END1(S1END[1]),
    .S1END2(S1END[2]),
    .S1END3(S1END[3]),
