...
`endif
 ...
 //Side.WEST
        output  [9:0] right2middle_RDATA,        //Port(Name=right2middle_RDATA, IO=OUTPUT, XOffset=-1, YOffset=0, WireCount=10, Side=WEST)
        input  [9:0] middle2right_WDATA,        //Port(Name=middle2right_WDATA, IO=INPUT, XOffset=1, YOffset=0, WireCount=10, Side=WEST)
        input  [9:0] middle2right_ADDR,        //Port(Name=middle2right_ADDR, IO=INPUT, XOffset=1, YOffset=0, WireCount=10, Side=WEST)
...
S_OBI_right_ConfigMem
`ifdef EMULATION
    #(
    .Emulate_Bitstream(Emulate_Bitstream)
    )
`endif
    Inst_S_OBI_right_ConfigMem
    (
    .FrameData(FrameData),
...
S_OBI_right_switch_matrix Inst_S_OBI_right_switch_matrix (
    .S1END0(S1END[0]),
    .S1END1(S1END[1]),
    .S1END2(S1END[2]),
    .S1END3(S1END[3]),
    ...
    .ConfigBits(ConfigBits[70-1:0]),
    .ConfigBits_N(ConfigBits_N[70-1:0])
);
