 // NumberOfConfigBits: 320
module IHP_BRAM_top_switch_matrix
    #(
    ...
    (
        ...
        input  bot2top_B_DOUT0,
        input  bot2top_B_DOUT1,
        input  bot2top_B_DOUT2,
        input  bot2top_B_DOUT3,
        input  bot2top_B_DOUT4,
        input  bot2top_B_DOUT5,
        input  bot2top_B_DOUT6,
        input  bot2top_B_DOUT7,
        input  J_NS4_END0,
        input  J_NS4_END1,
        input  J_NS4_END2,
        input  J_NS4_END3,
        ...
        output  top2bot_B_DIN0,
        output  top2bot_B_DIN1,
        output  top2bot_B_DIN2,
        output  top2bot_B_DIN3,
        output  top2bot_B_DIN4,
        output  top2bot_B_DIN5,
        output  top2bot_B_DIN6,
        output  top2bot_B_DIN7,
        output  top2bot_B_BM0,
        output  top2bot_B_BM1,
        output  top2bot_B_BM2,
        output  top2bot_B_BM3,
        output  top2bot_B_BM4,
        output  top2bot_B_BM5,
        output  top2bot_B_BM6,
        output  top2bot_B_BM7,
        output  top2bot_B_ADDR0,
        output  top2bot_B_ADDR1,
        output  top2bot_B_ADDR2,
        output  top2bot_B_ADDR3,
        output  top2bot_B_ADDR4,
        output  top2bot_B_WEN0,
        output  top2bot_B_MEN0,
        output  top2bot_B_REN0,
        output  J_NS4_BEG0,
        output  J_NS4_BEG1,
        output  J_NS4_BEG2,
        output  J_NS4_BEG3,
...
wire[4-1:0] top2bot_B_DIN0_input;
wire[4-1:0] top2bot_B_DIN1_input;
wire[4-1:0] top2bot_B_DIN2_input;
wire[4-1:0] top2bot_B_DIN3_input;
wire[4-1:0] top2bot_B_DIN4_input;
wire[4-1:0] top2bot_B_DIN5_input;
wire[4-1:0] top2bot_B_DIN6_input;
wire[4-1:0] top2bot_B_DIN7_input;
wire[4-1:0] top2bot_B_BM0_input;
wire[4-1:0] top2bot_B_BM1_input;
wire[4-1:0] top2bot_B_BM2_input;
wire[4-1:0] top2bot_B_BM3_input;
wire[4-1:0] top2bot_B_BM4_input;
wire[4-1:0] top2bot_B_BM5_input;
wire[4-1:0] top2bot_B_BM6_input;
wire[4-1:0] top2bot_B_BM7_input;
wire[4-1:0] top2bot_B_ADDR0_input;
wire[4-1:0] top2bot_B_ADDR1_input;
wire[4-1:0] top2bot_B_ADDR2_input;
wire[4-1:0] top2bot_B_ADDR3_input;
wire[4-1:0] top2bot_B_ADDR4_input;
wire[16-1:0] top2bot_B_WEN0_input;
wire[16-1:0] top2bot_B_MEN0_input;
wire[16-1:0] top2bot_B_REN0_input;
...
assign W2BEG0_input = {J_NS2_END7,J_NS2_END0,bot2top_B_DOUT0,bot2top_A_DOUT0};
...
assign W2BEG1_input = {J_NS2_END6,J_NS2_END1,bot2top_B_DOUT1,bot2top_A_DOUT1};
...
assign W2BEG2_input = {J_NS2_END5,J_NS2_END2,bot2top_B_DOUT2,bot2top_A_DOUT2};
...
assign W2BEG3_input = {J_NS2_END4,J_NS2_END3,bot2top_B_DOUT3,bot2top_A_DOUT3};
...
assign W2BEG4_input = {J_NS2_END4,J_NS2_END3,bot2top_B_DOUT4,bot2top_A_DOUT4};
...
assign W2BEG5_input = {J_NS2_END5,J_NS2_END2,bot2top_B_DOUT5,bot2top_A_DOUT5};
...
assign W2BEG6_input = {J_NS2_END6,J_NS2_END1,bot2top_B_DOUT6,bot2top_A_DOUT6};
...
assign W2BEG7_input = {J_NS2_END7,J_NS2_END0,bot2top_B_DOUT7,bot2top_A_DOUT7};
...
assign W2BEGb0_input = {J_NS2_END7,J_NS2_END0,bot2top_B_DOUT0,bot2top_A_DOUT0};
...
assign W2BEGb1_input = {J_NS2_END6,J_NS2_END1,bot2top_B_DOUT1,bot2top_A_DOUT1};
...
assign W2BEGb2_input = {J_NS2_END5,J_NS2_END2,bot2top_B_DOUT2,bot2top_A_DOUT2};
...
assign W2BEGb3_input = {J_NS2_END4,J_NS2_END3,bot2top_B_DOUT3,bot2top_A_DOUT3};
...
assign W2BEGb4_input = {J_NS2_END4,J_NS2_END3,bot2top_B_DOUT4,bot2top_A_DOUT4};
...
assign W2BEGb5_input = {J_NS2_END5,J_NS2_END2,bot2top_B_DOUT5,bot2top_A_DOUT5};
...
assign W2BEGb6_input = {J_NS2_END6,J_NS2_END1,bot2top_B_DOUT6,bot2top_A_DOUT6};
...
assign W2BEGb7_input = {J_NS2_END7,J_NS2_END0,bot2top_B_DOUT7,bot2top_A_DOUT7};
...
assign WW4BEG0_input = {J_NS2_END7,J_NS4_END15,bot2top_B_DOUT4,bot2top_A_DOUT0};
...
assign WW4BEG1_input = {J_NS2_END6,J_NS4_END14,bot2top_B_DOUT5,bot2top_A_DOUT1};
...
assign WW4BEG2_input = {J_NS2_END5,J_NS4_END13,bot2top_B_DOUT6,bot2top_A_DOUT2};
...
assign WW4BEG3_input = {J_NS2_END4,J_NS4_END12,bot2top_B_DOUT7,bot2top_A_DOUT3};
...
assign WW4BEG4_input = {J_NS2_END3,J_NS4_END11,bot2top_B_DOUT0,bot2top_A_DOUT4};
...
assign WW4BEG5_input = {J_NS2_END2,J_NS4_END10,bot2top_B_DOUT0,bot2top_A_DOUT5};
...
assign WW4BEG6_input = {J_NS2_END1,J_NS4_END9,bot2top_B_DOUT2,bot2top_A_DOUT6};
...
assign WW4BEG7_input = {J_NS2_END0,J_NS4_END8,bot2top_B_DOUT3,bot2top_A_DOUT7};
...
assign WW4BEG8_input = {J_NS2_END7,J_NS4_END7,bot2top_B_DOUT0,bot2top_A_DOUT4};
...
assign WW4BEG9_input = {J_NS2_END6,J_NS4_END6,bot2top_B_DOUT1,bot2top_A_DOUT5};
...
assign WW4BEG10_input = {J_NS2_END5,J_NS4_END5,bot2top_B_DOUT2,bot2top_A_DOUT6};
...
assign WW4BEG11_input = {J_NS2_END4,J_NS4_END4,bot2top_B_DOUT3,bot2top_A_DOUT7};
...
assign WW4BEG12_input = {J_NS2_END3,J_NS4_END3,bot2top_B_DOUT4,bot2top_A_DOUT0};
...
assign WW4BEG13_input = {J_NS2_END2,J_NS4_END2,bot2top_B_DOUT5,bot2top_A_DOUT1};
...
assign WW4BEG14_input = {J_NS2_END1,J_NS4_END1,bot2top_B_DOUT6,bot2top_A_DOUT2};
...
assign WW4BEG15_input = {J_NS2_END0,J_NS4_END0,bot2top_B_DOUT7,bot2top_A_DOUT3};
...
cus_mux41_buf inst_cus_mux41_buf_top2bot_A_ADDR4 (
 ...
 //switch matrix multiplexer top2bot_B_DIN0 MUX-4
assign top2bot_B_DIN0_input = {J_NS4_END8,E6END8,EE4END8,EE4END0};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN0 (
    .A0(top2bot_B_DIN0_input[0]),
    .A1(top2bot_B_DIN0_input[1]),
    .A2(top2bot_B_DIN0_input[2]),
    .A3(top2bot_B_DIN0_input[3]),
    .S0(ConfigBits[210+0]),
 ...
 //switch matrix multiplexer top2bot_B_DIN1 MUX-4
assign top2bot_B_DIN1_input = {J_NS4_END9,E6END9,EE4END9,EE4END1};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN1 (
    .A0(top2bot_B_DIN1_input[0]),
    .A1(top2bot_B_DIN1_input[1]),
    .A2(top2bot_B_DIN1_input[2]),
    .A3(top2bot_B_DIN1_input[3]),
    .S0(ConfigBits[212+0]),
 ...
 //switch matrix multiplexer top2bot_B_DIN2 MUX-4
assign top2bot_B_DIN2_input = {J_NS4_END10,E6END10,EE4END10,EE4END2};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN2 (
    .A0(top2bot_B_DIN2_input[0]),
    .A1(top2bot_B_DIN2_input[1]),
    .A2(top2bot_B_DIN2_input[2]),
    .A3(top2bot_B_DIN2_input[3]),
    .S0(ConfigBits[214+0]),
 ...
 //switch matrix multiplexer top2bot_B_DIN3 MUX-4
assign top2bot_B_DIN3_input = {J_NS4_END11,E6END11,EE4END11,EE4END3};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN3 (
    .A0(top2bot_B_DIN3_input[0]),
    .A1(top2bot_B_DIN3_input[1]),
    .A2(top2bot_B_DIN3_input[2]),
    .A3(top2bot_B_DIN3_input[3]),
    .S0(ConfigBits[216+0]),
 ...
 //switch matrix multiplexer top2bot_B_DIN4 MUX-4
assign top2bot_B_DIN4_input = {J_NS4_END12,EE4END12,EE4END4,E1END0};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN4 (
    .A0(top2bot_B_DIN4_input[0]),
    .A1(top2bot_B_DIN4_input[1]),
    .A2(top2bot_B_DIN4_input[2]),
    .A3(top2bot_B_DIN4_input[3]),
    .S0(ConfigBits[218+0]),
 ...
 //switch matrix multiplexer top2bot_B_DIN5 MUX-4
assign top2bot_B_DIN5_input = {J_NS4_END13,EE4END13,EE4END5,E1END1};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN5 (
    .A0(top2bot_B_DIN5_input[0]),
    .A1(top2bot_B_DIN5_input[1]),
    .A2(top2bot_B_DIN5_input[2]),
    .A3(top2bot_B_DIN5_input[3]),
    .S0(ConfigBits[220+0]),
 ...
 //switch matrix multiplexer top2bot_B_DIN6 MUX-4
assign top2bot_B_DIN6_input = {J_NS4_END14,EE4END14,EE4END6,E1END2};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN6 (
    .A0(top2bot_B_DIN6_input[0]),
    .A1(top2bot_B_DIN6_input[1]),
    .A2(top2bot_B_DIN6_input[2]),
    .A3(top2bot_B_DIN6_input[3]),
    .S0(ConfigBits[222+0]),
 ...
 //switch matrix multiplexer top2bot_B_DIN7 MUX-4
assign top2bot_B_DIN7_input = {J_NS4_END15,EE4END15,EE4END7,E1END3};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_DIN7 (
    .A0(top2bot_B_DIN7_input[0]),
    .A1(top2bot_B_DIN7_input[1]),
    .A2(top2bot_B_DIN7_input[2]),
    .A3(top2bot_B_DIN7_input[3]),
    .S0(ConfigBits[224+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM0 MUX-4
assign top2bot_B_BM0_input = {J_NS4_END8,E6END8,EE4END8,EE4END0};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM0 (
    .A0(top2bot_B_BM0_input[0]),
    .A1(top2bot_B_BM0_input[1]),
    .A2(top2bot_B_BM0_input[2]),
    .A3(top2bot_B_BM0_input[3]),
    .S0(ConfigBits[226+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM1 MUX-4
assign top2bot_B_BM1_input = {J_NS4_END9,E6END9,EE4END9,EE4END1};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM1 (
    .A0(top2bot_B_BM1_input[0]),
    .A1(top2bot_B_BM1_input[1]),
    .A2(top2bot_B_BM1_input[2]),
    .A3(top2bot_B_BM1_input[3]),
    .S0(ConfigBits[228+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM2 MUX-4
assign top2bot_B_BM2_input = {J_NS4_END10,E6END10,EE4END10,EE4END2};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM2 (
    .A0(top2bot_B_BM2_input[0]),
    .A1(top2bot_B_BM2_input[1]),
    .A2(top2bot_B_BM2_input[2]),
    .A3(top2bot_B_BM2_input[3]),
    .S0(ConfigBits[230+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM3 MUX-4
assign top2bot_B_BM3_input = {J_NS4_END11,E6END11,EE4END11,EE4END3};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM3 (
    .A0(top2bot_B_BM3_input[0]),
    .A1(top2bot_B_BM3_input[1]),
    .A2(top2bot_B_BM3_input[2]),
    .A3(top2bot_B_BM3_input[3]),
    .S0(ConfigBits[232+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM4 MUX-4
assign top2bot_B_BM4_input = {J_NS4_END12,EE4END12,EE4END4,E1END0};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM4 (
    .A0(top2bot_B_BM4_input[0]),
    .A1(top2bot_B_BM4_input[1]),
    .A2(top2bot_B_BM4_input[2]),
    .A3(top2bot_B_BM4_input[3]),
    .S0(ConfigBits[234+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM5 MUX-4
assign top2bot_B_BM5_input = {J_NS4_END13,EE4END13,EE4END5,E1END1};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM5 (
    .A0(top2bot_B_BM5_input[0]),
    .A1(top2bot_B_BM5_input[1]),
    .A2(top2bot_B_BM5_input[2]),
    .A3(top2bot_B_BM5_input[3]),
    .S0(ConfigBits[236+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM6 MUX-4
assign top2bot_B_BM6_input = {J_NS4_END14,EE4END14,EE4END6,E1END2};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM6 (
    .A0(top2bot_B_BM6_input[0]),
    .A1(top2bot_B_BM6_input[1]),
    .A2(top2bot_B_BM6_input[2]),
    .A3(top2bot_B_BM6_input[3]),
    .S0(ConfigBits[238+0]),
 ...
 //switch matrix multiplexer top2bot_B_BM7 MUX-4
assign top2bot_B_BM7_input = {J_NS4_END15,EE4END15,EE4END7,E1END3};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_BM7 (
    .A0(top2bot_B_BM7_input[0]),
    .A1(top2bot_B_BM7_input[1]),
    .A2(top2bot_B_BM7_input[2]),
    .A3(top2bot_B_BM7_input[3]),
    .S0(ConfigBits[240+0]),
 ...
 //switch matrix multiplexer top2bot_B_ADDR0 MUX-4
assign top2bot_B_ADDR0_input = {GND0,J_NS2_END0,E2END0,E2MID0};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_ADDR0 (
    .A0(top2bot_B_ADDR0_input[0]),
    .A1(top2bot_B_ADDR0_input[1]),
    .A2(top2bot_B_ADDR0_input[2]),
    .A3(top2bot_B_ADDR0_input[3]),
    .S0(ConfigBits[242+0]),
 ...
 //switch matrix multiplexer top2bot_B_ADDR1 MUX-4
assign top2bot_B_ADDR1_input = {GND0,J_NS2_END1,E2END1,E2MID1};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_ADDR1 (
    .A0(top2bot_B_ADDR1_input[0]),
    .A1(top2bot_B_ADDR1_input[1]),
    .A2(top2bot_B_ADDR1_input[2]),
    .A3(top2bot_B_ADDR1_input[3]),
    .S0(ConfigBits[244+0]),
 ...
 //switch matrix multiplexer top2bot_B_ADDR2 MUX-4
assign top2bot_B_ADDR2_input = {GND0,J_NS2_END2,E2END2,E2MID2};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_ADDR2 (
    .A0(top2bot_B_ADDR2_input[0]),
    .A1(top2bot_B_ADDR2_input[1]),
    .A2(top2bot_B_ADDR2_input[2]),
    .A3(top2bot_B_ADDR2_input[3]),
    .S0(ConfigBits[246+0]),
 ...
 //switch matrix multiplexer top2bot_B_ADDR3 MUX-4
assign top2bot_B_ADDR3_input = {GND0,J_NS2_END3,E2END3,E2MID3};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_ADDR3 (
    .A0(top2bot_B_ADDR3_input[0]),
    .A1(top2bot_B_ADDR3_input[1]),
    .A2(top2bot_B_ADDR3_input[2]),
    .A3(top2bot_B_ADDR3_input[3]),
    .S0(ConfigBits[248+0]),
 ...
 //switch matrix multiplexer top2bot_B_ADDR4 MUX-4
assign top2bot_B_ADDR4_input = {GND0,J_NS2_END4,E2END4,E2MID4};
cus_mux41_buf inst_cus_mux41_buf_top2bot_B_ADDR4 (
    .A0(top2bot_B_ADDR4_input[0]),
    .A1(top2bot_B_ADDR4_input[1]),
    .A2(top2bot_B_ADDR4_input[2]),
    .A3(top2bot_B_ADDR4_input[3]),
    .S0(ConfigBits[250+0]),
 ...
 //switch matrix multiplexer top2bot_B_WEN0 MUX-16
assign top2bot_B_WEN0_input = {VCC0,GND0,S2END3,S2END2,S2MID0,E2END5,E2END4,E2END3,E2END2,E2END1,E2MID6,E2MID3,E2MID0,N2END3,N2END2,N2MID6};
cus_mux161_buf inst_cus_mux161_buf_top2bot_B_WEN0 (
    .A0(top2bot_B_WEN0_input[0]),
    .A1(top2bot_B_WEN0_input[1]),
    .A2(top2bot_B_WEN0_input[2]),
    .A3(top2bot_B_WEN0_input[3]),
    .A4(top2bot_B_WEN0_input[4]),
    .A5(top2bot_B_WEN0_input[5]),
    .A6(top2bot_B_WEN0_input[6]),
    .A7(top2bot_B_WEN0_input[7]),
    .A8(top2bot_B_WEN0_input[8]),
    .A9(top2bot_B_WEN0_input[9]),
    .A10(top2bot_B_WEN0_input[10]),
    .A11(top2bot_B_WEN0_input[11]),
    .A12(top2bot_B_WEN0_input[12]),
    .A13(top2bot_B_WEN0_input[13]),
    .A14(top2bot_B_WEN0_input[14]),
    .A15(top2bot_B_WEN0_input[15]),
    .S0(ConfigBits[252+0]),
 ...
 //switch matrix multiplexer top2bot_B_MEN0 MUX-16
assign top2bot_B_MEN0_input = {VCC0,GND0,S2END3,S2END2,S2MID0,E2END5,E2END4,E2END3,E2END2,E2END1,E2MID6,E2MID3,E2MID0,N2END3,N2END2,N2MID6};
cus_mux161_buf inst_cus_mux161_buf_top2bot_B_MEN0 (
    .A0(top2bot_B_MEN0_input[0]),
    .A1(top2bot_B_MEN0_input[1]),
    .A2(top2bot_B_MEN0_input[2]),
    .A3(top2bot_B_MEN0_input[3]),
    .A4(top2bot_B_MEN0_input[4]),
    .A5(top2bot_B_MEN0_input[5]),
    .A6(top2bot_B_MEN0_input[6]),
    .A7(top2bot_B_MEN0_input[7]),
    .A8(top2bot_B_MEN0_input[8]),
    .A9(top2bot_B_MEN0_input[9]),
    .A10(top2bot_B_MEN0_input[10]),
    .A11(top2bot_B_MEN0_input[11]),
    .A12(top2bot_B_MEN0_input[12]),
    .A13(top2bot_B_MEN0_input[13]),
    .A14(top2bot_B_MEN0_input[14]),
    .A15(top2bot_B_MEN0_input[15]),
    .S0(ConfigBits[256+0]),
 ...
 //switch matrix multiplexer top2bot_B_REN0 MUX-16
assign top2bot_B_REN0_input = {VCC0,GND0,S2END3,S2END2,S2MID0,E2END5,E2END4,E2END3,E2END2,E2END1,E2MID6,E2MID3,E2MID0,N2END3,N2END2,N2MID6};
cus_mux161_buf inst_cus_mux161_buf_top2bot_B_REN0 (
    .A0(top2bot_B_REN0_input[0]),
    .A1(top2bot_B_REN0_input[1]),
    .A2(top2bot_B_REN0_input[2]),
    .A3(top2bot_B_REN0_input[3]),
    .A4(top2bot_B_REN0_input[4]),
    .A5(top2bot_B_REN0_input[5]),
    .A6(top2bot_B_REN0_input[6]),
    .A7(top2bot_B_REN0_input[7]),
    .A8(top2bot_B_REN0_input[8]),
    .A9(top2bot_B_REN0_input[9]),
    .A10(top2bot_B_REN0_input[10]),
    .A11(top2bot_B_REN0_input[11]),
    .A12(top2bot_B_REN0_input[12]),
    .A13(top2bot_B_REN0_input[13]),
    .A14(top2bot_B_REN0_input[14]),
    .A15(top2bot_B_REN0_input[15]),
    .S0(ConfigBits[260+0]),
