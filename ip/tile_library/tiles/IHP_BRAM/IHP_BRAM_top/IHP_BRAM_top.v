...
`endif
 ...
 //Side.SOUTH
        ...
        input  [7:0] bot2top_A_DOUT,        //Port(Name=bot2top_A_DOUT, IO=INPUT, XOffset=0, YOffset=-1, WireCount=8, Side=SOUTH)
        output  [7:0] top2bot_A_DIN,        //Port(Name=top2bot_A_DIN, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=8, Side=SOUTH)
        output  [7:0] top2bot_A_BM,        //Port(Name=top2bot_A_BM, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=8, Side=SOUTH)
        output  [4:0] top2bot_A_ADDR,        //Port(Name=top2bot_A_ADDR, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=5, Side=SOUTH)
        input  [7:0] bot2top_B_DOUT,        //Port(Name=bot2top_B_DOUT, IO=INPUT, XOffset=0, YOffset=-1, WireCount=8, Side=SOUTH)
        output  [7:0] top2bot_B_DIN,        //Port(Name=top2bot_B_DIN, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=8, Side=SOUTH)
        output  [7:0] top2bot_B_BM,        //Port(Name=top2bot_B_BM, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=8, Side=SOUTH)
        output  [4:0] top2bot_B_ADDR,        //Port(Name=top2bot_B_ADDR, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=5, Side=SOUTH)
        output  [0:0] top2bot_B_WEN,        //Port(Name=top2bot_B_WEN, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=1, Side=SOUTH)
        output  [0:0] top2bot_B_MEN,        //Port(Name=top2bot_B_MEN, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=1, Side=SOUTH)
        output  [0:0] top2bot_B_REN,        //Port(Name=top2bot_B_REN, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=1, Side=SOUTH)
...
IHP_BRAM_top_ConfigMem
`ifdef EMULATION
    #(
    .Emulate_Bitstream(Emulate_Bitstream)
    )
`endif
    Inst_IHP_BRAM_top_ConfigMem
    (
    .FrameData(FrameData),
...
IHP_BRAM_top_switch_matrix Inst_IHP_BRAM_top_switch_matrix (
    .N1END0(N1END[0]),
    .N1END1(N1END[1]),
    .N1END2(N1END[2]),
    .N1END3(N1END[3]),
