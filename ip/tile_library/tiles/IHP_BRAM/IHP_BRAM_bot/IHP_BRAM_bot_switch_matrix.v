...
module IHP_BRAM_bot_switch_matrix
    #(
    ...
    (
        ...
        input  top2bot_B_DIN0,
        input  top2bot_B_DIN1,
        input  top2bot_B_DIN2,
        input  top2bot_B_DIN3,
        input  top2bot_B_DIN4,
        input  top2bot_B_DIN5,
        input  top2bot_B_DIN6,
        input  top2bot_B_DIN7,
        input  top2bot_B_BM0,
        input  top2bot_B_BM1,
        input  top2bot_B_BM2,
        input  top2bot_B_BM3,
        ...
        input  top2bot_B_BM6,
        input  top2bot_B_BM7,
        input  top2bot_B_ADDR0,
        input  top2bot_B_ADDR1,
        input  top2bot_B_ADDR2,
        input  top2bot_B_ADDR3,
        input  top2bot_B_ADDR4,
        input  top2bot_B_WEN0,
        input  top2bot_B_MEN0,
        input  top2bot_B_REN0,
        input  A_DOUT0,
        input  A_DOUT1,
        input  A_DOUT2,
        input  A_DOUT3,
        ...
        output  bot2top_B_DOUT0,
        output  bot2top_B_DOUT1,
        output  bot2top_B_DOUT2,
        output  bot2top_B_DOUT3,
        output  bot2top_B_DOUT4,
        output  bot2top_B_DOUT5,
        output  bot2top_B_DOUT6,
        output  bot2top_B_DOUT7,
        output  A_ADDR0,
        output  A_ADDR1,
        output  A_ADDR2,
        output  A_ADDR3,
...
wire[4-1:0] B_ADDR0_input;
wire[4-1:0] B_ADDR1_input;
wire[4-1:0] B_ADDR2_input;
wire[4-1:0] B_ADDR3_input;
wire[4-1:0] B_ADDR4_input;
wire[4-1:0] B_DIN0_input;
wire[4-1:0] B_DIN1_input;
wire[4-1:0] B_DIN2_input;
wire[4-1:0] B_DIN3_input;
wire[4-1:0] B_DIN4_input;
wire[4-1:0] B_DIN5_input;
wire[4-1:0] B_DIN6_input;
wire[4-1:0] B_DIN7_input;
wire[4-1:0] B_BM0_input;
wire[4-1:0] B_BM1_input;
wire[4-1:0] B_BM2_input;
wire[4-1:0] B_BM3_input;
wire[4-1:0] B_BM4_input;
wire[4-1:0] B_BM5_input;
wire[4-1:0] B_BM6_input;
wire[4-1:0] B_BM7_input;
...
assign W2BEG0_input = {J_NS2_END7,J_NS2_END0,B_DOUT0,A_DOUT0};
...
assign W2BEG1_input = {J_NS2_END6,J_NS2_END1,B_DOUT1,A_DOUT1};
...
assign W2BEG2_input = {J_NS2_END5,J_NS2_END2,B_DOUT2,A_DOUT2};
...
assign W2BEG3_input = {J_NS2_END4,J_NS2_END3,B_DOUT3,A_DOUT3};
...
assign W2BEG4_input = {J_NS2_END4,J_NS2_END3,B_DOUT4,A_DOUT4};
...
assign W2BEG5_input = {J_NS2_END5,J_NS2_END2,B_DOUT5,A_DOUT5};
...
assign W2BEG6_input = {J_NS2_END6,J_NS2_END1,B_DOUT6,A_DOUT6};
...
assign W2BEG7_input = {J_NS2_END7,J_NS2_END0,B_DOUT7,A_DOUT7};
...
assign W2BEGb0_input = {J_NS2_END7,J_NS2_END0,B_DOUT0,A_DOUT0};
...
assign W2BEGb1_input = {J_NS2_END6,J_NS2_END1,B_DOUT1,A_DOUT1};
...
assign W2BEGb2_input = {J_NS2_END5,J_NS2_END2,B_DOUT2,A_DOUT2};
...
assign W2BEGb3_input = {J_NS2_END4,J_NS2_END3,B_DOUT3,A_DOUT3};
...
assign W2BEGb4_input = {J_NS2_END4,J_NS2_END3,B_DOUT4,A_DOUT4};
...
assign W2BEGb5_input = {J_NS2_END5,J_NS2_END2,B_DOUT5,A_DOUT5};
...
assign W2BEGb6_input = {J_NS2_END6,J_NS2_END1,B_DOUT6,A_DOUT6};
...
assign W2BEGb7_input = {J_NS2_END7,J_NS2_END0,B_DOUT7,A_DOUT7};
...
assign WW4BEG0_input = {J_NS2_END7,J_NS4_END15,B_DOUT4,A_DOUT0};
...
assign WW4BEG1_input = {J_NS2_END6,J_NS4_END14,B_DOUT5,A_DOUT1};
...
assign WW4BEG2_input = {J_NS2_END5,J_NS4_END13,B_DOUT6,A_DOUT2};
...
assign WW4BEG3_input = {J_NS2_END4,J_NS4_END12,B_DOUT7,A_DOUT3};
...
assign WW4BEG4_input = {J_NS2_END3,J_NS4_END11,B_DOUT0,A_DOUT4};
...
assign WW4BEG5_input = {J_NS2_END2,J_NS4_END10,B_DOUT1,A_DOUT5};
...
assign WW4BEG6_input = {J_NS2_END1,J_NS4_END9,B_DOUT2,A_DOUT6};
...
assign WW4BEG7_input = {J_NS2_END0,J_NS4_END8,B_DOUT3,A_DOUT7};
...
assign WW4BEG8_input = {J_NS2_END7,J_NS4_END7,B_DOUT0,A_DOUT4};
...
assign WW4BEG9_input = {J_NS2_END6,J_NS4_END6,B_DOUT1,A_DOUT5};
...
assign WW4BEG10_input = {J_NS2_END5,J_NS4_END5,B_DOUT2,A_DOUT6};
...
assign WW4BEG11_input = {J_NS2_END4,J_NS4_END4,B_DOUT3,A_DOUT7};
...
assign WW4BEG12_input = {J_NS2_END3,J_NS4_END3,B_DOUT4,A_DOUT0};
...
assign WW4BEG13_input = {J_NS2_END2,J_NS4_END2,B_DOUT5,A_DOUT1};
...
assign WW4BEG14_input = {J_NS2_END1,J_NS4_END1,B_DOUT6,A_DOUT2};
...
assign WW4BEG15_input = {J_NS2_END0,J_NS4_END0,B_DOUT7,A_DOUT3};
...
assign bot2top_A_DOUT0 = A_DOUT8;

 //switch matrix multiplexer bot2top_A_DOUT1 MUX-1
assign bot2top_A_DOUT1 = A_DOUT9;

 //switch matrix multiplexer bot2top_A_DOUT2 MUX-1
assign bot2top_A_DOUT2 = A_DOUT10;

 //switch matrix multiplexer bot2top_A_DOUT3 MUX-1
assign bot2top_A_DOUT3 = A_DOUT11;

 //switch matrix multiplexer bot2top_A_DOUT4 MUX-1
assign bot2top_A_DOUT4 = A_DOUT12;

 //switch matrix multiplexer bot2top_A_DOUT5 MUX-1
assign bot2top_A_DOUT5 = A_DOUT13;

 //switch matrix multiplexer bot2top_A_DOUT6 MUX-1
assign bot2top_A_DOUT6 = A_DOUT14;

 //switch matrix multiplexer bot2top_A_DOUT7 MUX-1
assign bot2top_A_DOUT7 = A_DOUT15;

 //switch matrix multiplexer bot2top_B_DOUT0 MUX-1
assign bot2top_B_DOUT0 = B_DOUT8;

 //switch matrix multiplexer bot2top_B_DOUT1 MUX-1
assign bot2top_B_DOUT1 = B_DOUT9;

 //switch matrix multiplexer bot2top_B_DOUT2 MUX-1
assign bot2top_B_DOUT2 = B_DOUT10;

 //switch matrix multiplexer bot2top_B_DOUT3 MUX-1
assign bot2top_B_DOUT3 = B_DOUT11;

 //switch matrix multiplexer bot2top_B_DOUT4 MUX-1
assign bot2top_B_DOUT4 = B_DOUT12;

 //switch matrix multiplexer bot2top_B_DOUT5 MUX-1
assign bot2top_B_DOUT5 = B_DOUT13;

 //switch matrix multiplexer bot2top_B_DOUT6 MUX-1
assign bot2top_B_DOUT6 = B_DOUT14;

 //switch matrix multiplexer bot2top_B_DOUT7 MUX-1
assign bot2top_B_DOUT7 = B_DOUT15;
...
cus_mux41_buf inst_cus_mux41_buf_A_DIN7 (
 ...
 //switch matrix multiplexer A_DIN8 MUX-1
assign A_DIN8 = top2bot_A_DIN0;

 //switch matrix multiplexer A_DIN9 MUX-1
assign A_DIN9 = top2bot_A_DIN1;

 //switch matrix multiplexer A_DIN10 MUX-1
assign A_DIN10 = top2bot_A_DIN2;

 //switch matrix multiplexer A_DIN11 MUX-1
assign A_DIN11 = top2bot_A_DIN3;

 //switch matrix multiplexer A_DIN12 MUX-1
assign A_DIN12 = top2bot_A_DIN4;

 //switch matrix multiplexer A_DIN13 MUX-1
assign A_DIN13 = top2bot_A_DIN5;

 //switch matrix multiplexer A_DIN14 MUX-1
assign A_DIN14 = top2bot_A_DIN6;

 //switch matrix multiplexer A_DIN15 MUX-1
assign A_DIN15 = top2bot_A_DIN7;
...
cus_mux41_buf inst_cus_mux41_buf_A_BM7 (
 ...
 //switch matrix multiplexer A_BM8 MUX-1
assign A_BM8 = top2bot_A_BM0;

 //switch matrix multiplexer A_BM9 MUX-1
assign A_BM9 = top2bot_A_BM1;

 //switch matrix multiplexer A_BM10 MUX-1
assign A_BM10 = top2bot_A_BM2;

 //switch matrix multiplexer A_BM11 MUX-1
assign A_BM11 = top2bot_A_BM3;

 //switch matrix multiplexer A_BM12 MUX-1
assign A_BM12 = top2bot_A_BM4;

 //switch matrix multiplexer A_BM13 MUX-1
assign A_BM13 = top2bot_A_BM5;

 //switch matrix multiplexer A_BM14 MUX-1
assign A_BM14 = top2bot_A_BM6;

 //switch matrix multiplexer A_BM15 MUX-1
assign A_BM15 = top2bot_A_BM7;
...
cus_mux161_buf inst_cus_mux161_buf_A_REN (
 ...
 //switch matrix multiplexer B_ADDR0 MUX-4
assign B_ADDR0_input = {GND0,J_NS2_END0,E2END0,E2MID0};
cus_mux41_buf inst_cus_mux41_buf_B_ADDR0 (
    .A0(B_ADDR0_input[0]),
    .A1(B_ADDR0_input[1]),
    .A2(B_ADDR0_input[2]),
    .A3(B_ADDR0_input[3]),
 ...
 //switch matrix multiplexer B_ADDR1 MUX-4
assign B_ADDR1_input = {GND0,J_NS2_END1,E2END1,E2MID1};
cus_mux41_buf inst_cus_mux41_buf_B_ADDR1 (
    .A0(B_ADDR1_input[0]),
    .A1(B_ADDR1_input[1]),
    .A2(B_ADDR1_input[2]),
    .A3(B_ADDR1_input[3]),
 ...
 //switch matrix multiplexer B_ADDR2 MUX-4
assign B_ADDR2_input = {GND0,J_NS2_END2,E2END2,E2MID2};
cus_mux41_buf inst_cus_mux41_buf_B_ADDR2 (
    .A0(B_ADDR2_input[0]),
    .A1(B_ADDR2_input[1]),
    .A2(B_ADDR2_input[2]),
    .A3(B_ADDR2_input[3]),
 ...
 //switch matrix multiplexer B_ADDR3 MUX-4
assign B_ADDR3_input = {GND0,J_NS2_END3,E2END3,E2MID3};
cus_mux41_buf inst_cus_mux41_buf_B_ADDR3 (
    .A0(B_ADDR3_input[0]),
    .A1(B_ADDR3_input[1]),
    .A2(B_ADDR3_input[2]),
    .A3(B_ADDR3_input[3]),
 ...
 //switch matrix multiplexer B_ADDR4 MUX-4
assign B_ADDR4_input = {GND0,J_NS2_END4,E2END4,E2MID4};
cus_mux41_buf inst_cus_mux41_buf_B_ADDR4 (
    .A0(B_ADDR4_input[0]),
    .A1(B_ADDR4_input[1]),
    .A2(B_ADDR4_input[2]),
    .A3(B_ADDR4_input[3]),
 ...
 //switch matrix multiplexer B_ADDR5 MUX-1
assign B_ADDR5 = top2bot_B_ADDR0;

 //switch matrix multiplexer B_ADDR6 MUX-1
assign B_ADDR6 = top2bot_B_ADDR1;

 //switch matrix multiplexer B_ADDR7 MUX-1
assign B_ADDR7 = top2bot_B_ADDR2;

 //switch matrix multiplexer B_ADDR8 MUX-1
assign B_ADDR8 = top2bot_B_ADDR3;

 //switch matrix multiplexer B_ADDR9 MUX-1
assign B_ADDR9 = top2bot_B_ADDR4;

 //switch matrix multiplexer B_DIN0 MUX-4
assign B_DIN0_input = {J_NS4_END8,E6END8,EE4END8,EE4END0};
cus_mux41_buf inst_cus_mux41_buf_B_DIN0 (
    .A0(B_DIN0_input[0]),
    .A1(B_DIN0_input[1]),
    .A2(B_DIN0_input[2]),
    .A3(B_DIN0_input[3]),
 ...
 //switch matrix multiplexer B_DIN1 MUX-4
assign B_DIN1_input = {J_NS4_END9,E6END9,EE4END9,EE4END1};
cus_mux41_buf inst_cus_mux41_buf_B_DIN1 (
    .A0(B_DIN1_input[0]),
    .A1(B_DIN1_input[1]),
    .A2(B_DIN1_input[2]),
    .A3(B_DIN1_input[3]),
 ...
 //switch matrix multiplexer B_DIN2 MUX-4
assign B_DIN2_input = {J_NS4_END10,E6END10,EE4END10,EE4END2};
cus_mux41_buf inst_cus_mux41_buf_B_DIN2 (
    .A0(B_DIN2_input[0]),
    .A1(B_DIN2_input[1]),
    .A2(B_DIN2_input[2]),
    .A3(B_DIN2_input[3]),
 ...
 //switch matrix multiplexer B_DIN3 MUX-4
assign B_DIN3_input = {J_NS4_END11,E6END11,EE4END11,EE4END3};
cus_mux41_buf inst_cus_mux41_buf_B_DIN3 (
    .A0(B_DIN3_input[0]),
    .A1(B_DIN3_input[1]),
    .A2(B_DIN3_input[2]),
    .A3(B_DIN3_input[3]),
 ...
 //switch matrix multiplexer B_DIN4 MUX-4
assign B_DIN4_input = {J_NS4_END12,EE4END12,EE4END4,E1END0};
cus_mux41_buf inst_cus_mux41_buf_B_DIN4 (
    .A0(B_DIN4_input[0]),
    .A1(B_DIN4_input[1]),
    .A2(B_DIN4_input[2]),
    .A3(B_DIN4_input[3]),
 ...
 //switch matrix multiplexer B_DIN5 MUX-4
assign B_DIN5_input = {J_NS4_END13,EE4END13,EE4END5,E1END1};
cus_mux41_buf inst_cus_mux41_buf_B_DIN5 (
    .A0(B_DIN5_input[0]),
    .A1(B_DIN5_input[1]),
    .A2(B_DIN5_input[2]),
    .A3(B_DIN5_input[3]),
 ...
 //switch matrix multiplexer B_DIN6 MUX-4
assign B_DIN6_input = {J_NS4_END14,EE4END14,EE4END6,E1END2};
cus_mux41_buf inst_cus_mux41_buf_B_DIN6 (
    .A0(B_DIN6_input[0]),
    .A1(B_DIN6_input[1]),
    .A2(B_DIN6_input[2]),
    .A3(B_DIN6_input[3]),
 ...
 //switch matrix multiplexer B_DIN7 MUX-4
assign B_DIN7_input = {J_NS4_END15,EE4END15,EE4END7,E1END3};
cus_mux41_buf inst_cus_mux41_buf_B_DIN7 (
    .A0(B_DIN7_input[0]),
    .A1(B_DIN7_input[1]),
    .A2(B_DIN7_input[2]),
    .A3(B_DIN7_input[3]),
 ...
 //switch matrix multiplexer B_DIN8 MUX-1
assign B_DIN8 = top2bot_B_DIN0;

 //switch matrix multiplexer B_DIN9 MUX-1
assign B_DIN9 = top2bot_B_DIN1;

 //switch matrix multiplexer B_DIN10 MUX-1
assign B_DIN10 = top2bot_B_DIN2;

 //switch matrix multiplexer B_DIN11 MUX-1
assign B_DIN11 = top2bot_B_DIN3;

 //switch matrix multiplexer B_DIN12 MUX-1
assign B_DIN12 = top2bot_B_DIN4;

 //switch matrix multiplexer B_DIN13 MUX-1
assign B_DIN13 = top2bot_B_DIN5;

 //switch matrix multiplexer B_DIN14 MUX-1
assign B_DIN14 = top2bot_B_DIN6;

 //switch matrix multiplexer B_DIN15 MUX-1
assign B_DIN15 = top2bot_B_DIN7;

 //switch matrix multiplexer B_BM0 MUX-4
assign B_BM0_input = {J_NS4_END8,E6END8,EE4END8,EE4END0};
cus_mux41_buf inst_cus_mux41_buf_B_BM0 (
    .A0(B_BM0_input[0]),
    .A1(B_BM0_input[1]),
    .A2(B_BM0_input[2]),
    .A3(B_BM0_input[3]),
 ...
 //switch matrix multiplexer B_BM1 MUX-4
assign B_BM1_input = {J_NS4_END9,E6END9,EE4END9,EE4END1};
cus_mux41_buf inst_cus_mux41_buf_B_BM1 (
    .A0(B_BM1_input[0]),
    .A1(B_BM1_input[1]),
    .A2(B_BM1_input[2]),
    .A3(B_BM1_input[3]),
 ...
 //switch matrix multiplexer B_BM2 MUX-4
assign B_BM2_input = {J_NS4_END10,E6END10,EE4END10,EE4END2};
cus_mux41_buf inst_cus_mux41_buf_B_BM2 (
    .A0(B_BM2_input[0]),
    .A1(B_BM2_input[1]),
    .A2(B_BM2_input[2]),
    .A3(B_BM2_input[3]),
 ...
 //switch matrix multiplexer B_BM3 MUX-4
assign B_BM3_input = {J_NS4_END11,E6END11,EE4END11,EE4END3};
cus_mux41_buf inst_cus_mux41_buf_B_BM3 (
    .A0(B_BM3_input[0]),
    .A1(B_BM3_input[1]),
    .A2(B_BM3_input[2]),
    .A3(B_BM3_input[3]),
 ...
 //switch matrix multiplexer B_BM4 MUX-4
assign B_BM4_input = {J_NS4_END12,EE4END12,EE4END4,E1END0};
cus_mux41_buf inst_cus_mux41_buf_B_BM4 (
    .A0(B_BM4_input[0]),
    .A1(B_BM4_input[1]),
    .A2(B_BM4_input[2]),
    .A3(B_BM4_input[3]),
 ...
 //switch matrix multiplexer B_BM5 MUX-4
assign B_BM5_input = {J_NS4_END13,EE4END13,EE4END5,E1END1};
cus_mux41_buf inst_cus_mux41_buf_B_BM5 (
    .A0(B_BM5_input[0]),
    .A1(B_BM5_input[1]),
    .A2(B_BM5_input[2]),
    .A3(B_BM5_input[3]),
 ...
 //switch matrix multiplexer B_BM6 MUX-4
assign B_BM6_input = {J_NS4_END14,EE4END14,EE4END6,E1END2};
cus_mux41_buf inst_cus_mux41_buf_B_BM6 (
    .A0(B_BM6_input[0]),
    .A1(B_BM6_input[1]),
    .A2(B_BM6_input[2]),
    .A3(B_BM6_input[3]),
 ...
 //switch matrix multiplexer B_BM7 MUX-4
assign B_BM7_input = {J_NS4_END15,EE4END15,EE4END7,E1END3};
cus_mux41_buf inst_cus_mux41_buf_B_BM7 (
    .A0(B_BM7_input[0]),
    .A1(B_BM7_input[1]),
    .A2(B_BM7_input[2]),
    .A3(B_BM7_input[3]),
 ...
 //switch matrix multiplexer B_BM8 MUX-1
assign B_BM8 = top2bot_B_BM0;

 //switch matrix multiplexer B_BM9 MUX-1
assign B_BM9 = top2bot_B_BM1;

 //switch matrix multiplexer B_BM10 MUX-1
assign B_BM10 = top2bot_B_BM2;

 //switch matrix multiplexer B_BM11 MUX-1
assign B_BM11 = top2bot_B_BM3;

 //switch matrix multiplexer B_BM12 MUX-1
assign B_BM12 = top2bot_B_BM4;

 //switch matrix multiplexer B_BM13 MUX-1
assign B_BM13 = top2bot_B_BM5;

 //switch matrix multiplexer B_BM14 MUX-1
assign B_BM14 = top2bot_B_BM6;

 //switch matrix multiplexer B_BM15 MUX-1
assign B_BM15 = top2bot_B_BM7;

 //switch matrix multiplexer B_WEN MUX-1
assign B_WEN = top2bot_B_WEN0;

 //switch matrix multiplexer B_MEN MUX-1
assign B_MEN = top2bot_B_MEN0;

 //switch matrix multiplexer B_REN MUX-1
assign B_REN = top2bot_B_REN0;
