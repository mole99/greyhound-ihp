...
`endif
    ...
    // WARMBOOT
    wire        fabric_warmboot_trigger_o;
    ...
    always_comb begin
        ...
        if (!rst_n_sync) begin
            ...
            if (fpga_mode_sync == 1'b0) begin
                ...
                // Slot and trigger
                spi_controller_start_i  = startup_trigger || ((fabric_warmboot_trigger_o || cpu_warmboot_boot_o) && !(fabric_config_busy || fabric_spi_controller_busy));
